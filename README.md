...
REnderizo los Pokemons siguientes (paginados):
* Todos los Pokemons (es decir sin filtro alguno)
ó
*Los Pokemons (Ordenados ALFAbeticamente)
ó
*Los Pokemons (Ordenados por Ataque (ASC/DESC))

ó
 
*Los Pokemons Filtrados x Origen (SIN Ordenar)
ó
*Los Pokemons Filtrados x Origen (Ordenados ALFAbeticamente)
ó
*Los Pokemons Filtrados x Origen (Ordenados por Ataque (ASC/DESC))

ó

*Los Pokemons Filtrados x Tipo (SIN Ordenar)
ó
Los Pokemons Filtrados x Tipo (Ordenados ALFAbeticamente)
ó
Los Pokemons Filtrados x Tipos (Ordenados por Ataque (ASC/DESC))

CONSULTA!!!: [NO se pide renderizar Pokemons Filtrados por ambos filtros (Origen Y Tipo)]
